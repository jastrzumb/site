  ...
  html.html([attribute.attribute("lang", "en")], [
    html.head([], [
      ...
      html.link([
        ...
        attribute.href(
          "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Ccircle cx='16' cy='16' r='16' fill='%23f5f2e8'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='central' text-anchor='middle' font-family='Space Mono, monospace' font-weight='700' font-size='28' fill='%233e2723'%3Eů%3C/text%3E%3C/svg%3E",
        ),
      ]),
      html.link([
        attribute.rel("stylesheet"),
